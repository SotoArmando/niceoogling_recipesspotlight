...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference("Schedule.count") do
      post schedules_url, params: { schedule: { schedule: @schedule.schedule, user_id: @schedule.user_id } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { schedule: @schedule.schedule, user_id: @schedule.user_id } }
